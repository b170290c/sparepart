              ...
              <form class="form-horizontal" method="POST" action="users_edit.php">
                <input type="hidden" class="userid" name="id">
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="edit_username" class="form-control" id="edit_username" name="username" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="edit_empid" class="col-sm-3 control-label">Employee ID</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_empid" name="empid" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="edit_plant" class="col-sm-3 control-label">Plant</label>

                    <div class="col-sm-9">
                      <select class="form-control" id="edit_plant" name="plant" required>
                       <option selected id="plantselected"></option>
                    </select>
                    </div>
                </div>
                <div class="form-group">
                    <label for="edit_line" class="col-sm-3 control-label">Line</label>

                    <div class="col-sm-9">
                      <select class="form-control" id="edit_line" name="line" required>
                       <option selected id="lineselected"></option>
                    </select>
                    </div>
                </div>
                   <div class="form-group">
