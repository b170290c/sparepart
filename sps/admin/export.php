...
header('Location: stockinpdf.php?var1='.$start1.'&var2='.$end1.'&var3='.$reportid);
}
...
header('Location: stockoutpdf.php?var1='.$start1.'&var2='.$end1.'&var3='.$reportid);
}
...
header('Location: lowstockpdf.php?var1='.$start1.'&var2='.$end1.'&var3='.$reportid);
}
...
header('Location: summarypdf.php?var1='.$start1.'&var2='.$end1.'&var3='.$reportid);
}
...
header('Location: scrappdf.php?var1='.$start1.'&var2='.$end1.'&var3='.$reportid);
}
...
//dquery conn
 ...
 // ORDER BY sales_date DESC";
    ...
    $sql = " SELECT * FROM sps.details INNER JOIN sps.products ON products.id=details.product_id
            INNER JOIN sps.sales on details.sales_id=sales.id
            INNER JOIN sps.users1 ON users1.id=sales.user_id
            WHERE sales_date BETWEEN '$start' AND '$end'
            ORDER BY sales_date DESC ";
     $params = array();
...
$pdf->Row(Array(
  ...
  $id,
 'Requested Date:'.chr(10).$item['sales_date']->format(("d-M-y h:i a")) .
