...
if( $ostat == 0 ){
                              ...
                              <input type='date' min='" . date("Y-m-d") . "' id='date' name='order'  data-id='".$row['salesid']."'required/><br/><br/>
                              <input type='number' size='5' name='blnc' value='".$blnc."' min='1' max='".$blnc."'  data-id='".$row['salesid']."' required > <br/><br/>
...
if( $ostat == 2 ){
                               ...
                               echo "<form action='order2.php' method='POST'>
                                      <input type='hidden' name='pID' value='".$pid."' data-id='".$row['salesid']."'>
                                      <input type='hidden' name='dID' value='".$details['detailid']."' data-id='".$row['salesid']."'>
                                      <input type='hidden' name='sID' value='".$salesid."' data-id='".$row['salesid']."'>
                                      ...
                                      <input type='hidden' name='balqty' value='".$quantity1."' data-id='".$row['salesid']."'>

                              <td>
                              <b>Filled in by parts collector!</b></br>
                               <strong> Quantity received : </strong><br/>
                               <input type='number' size='5' name='blnc'  min='1' max='".$blnc."'  data-id='".$row['salesid']."' required > <br/>
