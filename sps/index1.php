...
<div class="wrapper">
 ...
 $sql = "SELECT p.name as name , c.name as catname , p.photo as photo , p.slug as slug , p.qnty as qnty FROM sps.products p LEFT JOIN sps.category c ON c.id=p.category_id ORDER BY name asc";
                      $params = array();
	       							...
	       							<div class='col-sm-4'>
	       								<div class='box box-solid'>
		       								...
		       								<div class='box-footer'>
		       									<b>Ready Stock: ".number_format($row['qnty'])."</b>
