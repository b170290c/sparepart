...
#empID { background-position: 10px 10px !important }
...
<body>
  <?php
  if (isset($_GET['false'])){
    echo("<script>alert('Employee ID/Password is incorrect');</script>");
  }
  ?>
<div class="container">
  <section id="content">
    <form action="login.php">
      ...
      <div>
        <input type="text" autocomplete="off" placeholder="Employee ID" required name = "empID" />
      </div>
      <div>
