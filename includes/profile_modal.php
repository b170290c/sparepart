            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" selected disabled class="form-control" id="empid" name="empid" value="<?php echo $user['empid']; ?>" >
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" selected disabled class="form-control" id="plant" name="plant" value="<?php echo $user['plant']; ?>" >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" selected disabled class="form-control" id="line" name="line" value="<?php echo $user['line']; ?>" >
                    </div>
                </div>
                <div class="form-group">
